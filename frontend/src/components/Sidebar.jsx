...
export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 h-full w-60 bg-navy-900 border-r border-slate-800 flex flex-col z-40">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-slate-800">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-100 leading-none">Kite Portfolio</p>
      ...
      <div className="px-4 py-4 border-t border-slate-800">
        <p className="text-xs text-slate-600">Powered by Zerodha Kite MCP</p>
      </div>
    </aside>
  )
}
